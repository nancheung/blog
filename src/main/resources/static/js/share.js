...
(function($, window, document, undefined) {
	...
	var weixin = 'https://cli.im/api/qrcode/code?text={url}&mhid=sELPDFnok80gPHovKdI';
...
function loadShareInfo(target) {
	...
	var result = {
        ...
        url:domain+$(parent).data("url"),
        title:$(parent).data("title"),
        summary:$(parent).data("desc") != null?$(parent).data("desc"):'NanCheung个人博客分享,欢迎指教',
        pic: img
	};
	return result;
}