...
public class AdminCategoryController {
    ...
    public ResultInfo saveCateogry(Category category) {
        try {
            //解码
            category.setCategoryName(URLDecoder.decode(category.getCategoryName(), ProjectConstant.CHARSET));
            category.setAliasName(URLDecoder.decode(category.getAliasName(), ProjectConstant.CHARSET));
